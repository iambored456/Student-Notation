...
export function getPaintColor(midiValue: number | null | undefined, colorMode: 'shapenote' | 'chromatic' | undefined, selectedNoteColor?: string | null): [number, number, number] {
  if (midiValue === 0 || !midiValue) {
    return hexToRgb('#888888');
  }
