...
export function drawTonicShape(
  ...
  // CRITICAL: TonicSign.columnIndex is stored in FULL-SPACE (includes legend offset)
  // We need to convert to canvas-space before calling getColumnX
  const canvasSpaceColumn = tonicSign.columnIndex - 2;
