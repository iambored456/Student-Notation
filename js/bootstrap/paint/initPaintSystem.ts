// js/bootstrap/paint/initPaintSystem.ts
...
import PaintPlaybackService from '@services/paintPlaybackService.ts';
import MeterController from '@components/audio/meter/meterController.ts';
